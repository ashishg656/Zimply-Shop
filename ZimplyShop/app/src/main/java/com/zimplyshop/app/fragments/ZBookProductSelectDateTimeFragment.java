 ...
 */
public class ZBookProductSelectDateTimeFragment extends ZBaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        skipButton = (TextView) v.findViewById(R.id.skiptextbookfrag);
        okButton = (TextView) v.findViewById(R.id.oktextbookfrag);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.skiptextbookfrag:
                getActivity().onBackPressed();
                break;
            case R.id.oktextbookfrag:
                getActivity().onBackPressed();
                break;
        }
    }
